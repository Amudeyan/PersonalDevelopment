...
import com.example.Cards.dto.CardsContactDto;
...
public class CardsController {
    ...
    @Retry(name = "getContacts", fallbackMethod = "fallbackMethod")
    @GetMapping("/contact-info")
    public ResponseEntity<CardsContactDto> getContacts() {
    ...
    public ResponseEntity<CardsContactDto> fallbackMethod(Throwable throwable) {
        logger.debug("getBuildInfoFallback() method Invoked");
        //throw new RuntimeException("Cudtom");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(cardsContactDto);
    }
